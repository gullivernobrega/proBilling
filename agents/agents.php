...
<html lang="pt-br">
    <head>
        ...
        <meta name="author" content="Gulliver Nobrega">
    ...
    <body>
        ...
        <div class="base grSeashore">
            <div class="container-fluid">
                <!--AGENTS USERS-->
                <div class="row">
                    <div class="col-md-3 bRigt">
                        <div class="col-md-12 my-2"><i class="fa fa-user"></i><strong> <?php echo $agent_user; ?> </strong></div>
                        <div class="col-md-12 my-1"><i class="fa fa-users"></i> Atendimento</div>
                        <div class="col-md-12 mt-2">
                            <div class="row">
                                <div class="col-md-6"><i class="fa fa-fax"></i><strong> <?php echo $agent_ramal; ?></strong></div>
                                <div class="col-md-6"><i class="fa fa-clock-o"></i> 00:00</div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 bRigt">
                        ...
                        <div class="col-md-12">
                            <div class="row mb-2">
                                <div class="col-md-6 pl-0"><i class="fa fa-history"></i> 00:00:00</div>
                                <div class="col-md-6 pl-0"><i class="fa fa-hourglass-end"></i> 00:00:00</div>
                            </div>
                        </div>
                    </div>   
                    <!--MENU DE SERVIÇOS-->
                    <div class="col-md-6">
                        <ul class="nav nav-pills nav-fill my-2">
                            <li class="nav-item">
                                <a class="nav-link disabled icons" href="#"><i class="fa fa-volume-control-phone"></i> <p>Telefonia</p></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link disabled icons" href="#"><i class="fa fa-comments"></i> <p>Chat</p></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link disabled icons" href="#"><i class="fa fa-file-text-o"></i> <p>Menssagem</p></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link disabled icons" href="#"><i class="fa fa-calendar"></i> <p>Compromissos</p></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link disabled icons" href="#"><i class="fa fa-refresh"></i> <p>CRM</p></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link disabled icons" href="#"><i class="fa fa-question-circle"></i> <p>FAC</p></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link icons" href="index.php?acao=close" title="Sair do Sistema"><i class="fa fa-sign-out"></i> <p>Sair</p></a>
                            </li>
                        </ul>
                    </div>                
                </div>
...
//                        varDump::exeVD($arrs);
                ...
                <div class="col-md-9 px-0">
                    <div class="Mdagua"></div>
                    <!-- IFRAME VIRTUA -->                    
                    <!--<div class="embed-responsive embed-responsive-21by9">
                        <iframe class="embed-responsive-item"  src="http://200.175.139.182/virtua/" allowfullscreen></iframe>
                    </div>-->                    
                </div>
            </div>
        </div>
