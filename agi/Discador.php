...
while (true) {
   $conectaServidor = $conectaServidor = $asmanager->connect('127.0.0.1:5038', 'proBilling', 'proBilling');
    ...
    $Query = "SELECT * FROM campanha WHERE campanha_status = 'A' AND campanha_tipo = 'D'";
...
//                echo "\n\n\nPorcentagem  de agents       : $PorcentoAgents\n\n";
                ...
                if (!empty($limitMax) && !empty($limitMin)) {
                    ...
                    $quantiaChamadas = $quantiaChamadas * $agentsLivre;
                } else {
                ...
                $conn->Consultar($Query);
                $resultNum = $conn->consultaRetorno;
                $sleepNext = 1;
...
//                            $urlPortabilidade = "http://consultas.portabilidadecelular.com/painel/consulta_numero.php?user=brazistelecom&pass=vfqX8uNW&search_number=$numeroDestino";
//                            $operadora = file_get_contents($urlPortabilidade);
                            //$operadora = 55314;
                            //Forma correta de deixar para montar o Channel.
                            $call = "Channel: " . $rotaMovel . "/$numeroDestino" . "\n";
                            //Montagem temporaria do CHANNEL
//                            if ($operadora == 55321 || $operadora == 55341) {
//                                $call = "Channel: " . "SIP/SBC" . "/$numeroDestino" . "\n";
//                            } else {
//                                $call = "Channel: " . "SIP/SBC" . "/$numeroDestino" . "\n";
//                            }
...
//
//        $time += time();
//        touch("/var/www/html/proBilling/tmp/$file");
