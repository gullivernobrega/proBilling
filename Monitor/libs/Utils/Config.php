...
class Config
{
    ...
    public function __construct()
    {
        ...
        $this->file = realpath(realpath(__DIR__.'/../../conf/esm.config.json'));       
    ...
    private function _readFile()
    {
        ...
        if ($this->config == null && json_last_error() != JSON_ERROR_NONE)
        {
            ...
            throw new \LogicException(sprintf("Falha ao analisar o arquivo de configuração '%s'. Error: '%s'", basename($this->file) , json_last_error_msg()));
        }
    }
