...
esm.getSystem = function() {
    ...
    $.get('Monitor/libs/'+module+'.php', function(data) {

        var $box = $('#esm-'+module+' .box-content tbody');
...
esm.getLoad_average = function() {
    ...
    $.get('Monitor/libs/'+module+'.php', function(data) {
        ...
        var $box = $('#esm-'+module+' .box-content');
...
//            var label_status = data[line].status == 1 ? 'online' : 'offline';
            ...
            var html = '';
            html += '<tr>';
            html += '<td class="upercase"><span class="label '+label_color+'">'+label_status+'</span></td>';
            html += '<td>'+data[line].name+'</td>';
            html += '<td class="upercase">'+data[line].port+'</td>';
            html += '</tr>';
