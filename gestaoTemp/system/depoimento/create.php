...
<div class="conteudo">
<div class="top">
    <h1 class="tit">Categorias e Subcategorias <small>Cadastro!</small></h1>
</div>       
<!--</div>-->
                        ...
                        <div class="col-xs-5">
                            <select class="form-control" name="categoria_parente" id="categoria_parente">
                                ...
                                <?php
                                  ...
                                  $readParente->ExeRead("kl_categorias", "WHERE categoria_parente = :id ORDER BY categoria_nome ASC",  "id={$ID}");
