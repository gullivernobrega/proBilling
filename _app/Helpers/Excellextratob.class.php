...
/**
 * excellextratob.class [ HELPER ]
 * Realia um relatorio das busca em excel
 * @copyright (c) 29/03/2018, Kleber de Souza BRAZISTELECOM
 */

class Excellextratob {
    ...
    private function getSintax() {
        ...
        $xls .= "<h3>EXTRATO DA BUSCA POR PERÍODO</h3>";
        $xls .= "<table border='1'>";
        $xls .= "<tr>";
