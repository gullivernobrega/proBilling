    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div id="shieldui-grid1">
                ...
                if (!empty($Data["agentUpdate"])):
                    unset($Data["agentUpdate"]);

                    $update = new Agent;
                    $update->ExeUpdateSearch($agent_id, $Data);
                    ...
                    if ($update->getResult()):
                        ...
                        if ($geralConf->getResult()):
                            ...
                            //Redireciona
                            header("Location: painel.php?exe=gerenciamento/agentes/busca&agent_name={$Data['agent_name']}");
                        endif;                        
                    ...
                    if (!empty($updateSearch)):
                        unset($updateSearch['exe']);
                        $agent_id = $updateSearch['agent_id'];
                        $read = new Read;
                        $read->ExeRead("agents", "WHERE agent_id = :id", "id={$agent_id}");
                        $res = $read->getResult();
                        $Data = $res[0];
                    endif;
                ...
                <form role="form" class="form-horizontal txtblue" name="formNumero" action="" method="post" id="frm">  
                    <form role="form" class="form-horizontal txtblue" name="formSip" action="" method="post" id="frm">                          
                        ...
                        <div class="well txtCenter">
                            ...
                            <a class="btn btn-default" href="painel.php?exe=gerenciamento/agentes/busca&agent_name=<?php echo $Data['agent_name']; ?>" role="button"><i class="fa fa-arrow-left"></i> Voltar</a>
                        </div>
                    </form>
                    <!--</div>-->
                    <!--fim formulario-->
