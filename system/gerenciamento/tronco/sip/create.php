...
<div class="page-header">
    <h1>Troncos SIP<small>Cadastro!</small></h1>
</div>       
<!--</div>-->
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div id="shieldui-grid1">
                ...
                ?>
                <form role="form" class="form-horizontal txtblue" name="formTronco" action="" method="post" id="frm">                          
                    <!--NOME-->
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-xs-2">                                    
                            <input 
                                ...
                                value="<?php if (!empty($Data['tronco_remover_prefixo'])) echo $Data['tronco_remover_prefixo']; ?>" 
                                >                         
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-xs-2">                                    
                            <input 
                                ...
                                value="<?php if (!empty($Data['tronco_add_prefixo'])) echo $Data['tronco_add_prefixo']; ?>" 
                                >                         
