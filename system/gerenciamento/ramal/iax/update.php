...
<div class="page-header">
    <h1>Ramais IAX <small>Atualizar!</small></h1>
</div>       
<!--</div>-->
        ...
        <div class="panel-body">
            <div id="shieldui-grid1">
                ...
                if (isset($Data["iaxUpdate"])):
                    ...
                    $readSip = new Read;
                    $readSip->ExeRead("ramaliax", "WHERE iax_id = :id", "id={$iax_id}");
                    if (!$readSip->getResult()):
                        header("Location: painel.php?exe=gerenciamento/ramal/iax&update=false");
                    else:
