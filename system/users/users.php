                    ...
                    <tbody> 
                        ...
                        foreach ($obj as $us):
                            ...
                            <tr>
                                ...
                                <td><?php if(!empty($user_ramal)): echo $user_ramal; endif; ?></td> 
                                ...
                                <td>
                                    <?php                       
                                    //var_dump($NIVEL, $user_nivel);
                                    if ($NIVEL < $user_nivel):
                                        echo "<a href='' data-toggle='tooltip' data-placement='top' title='Editar'><i class='fa fa-edit size20'></i></a> ";
                                        echo '<a href="" data-placement="top" title="Apagar" class="del"><i class="fa fa-remove size20"></i></a>';
                                    else:
                                        echo "<a href='painel.php?exe=users/update&user_id={$user_id}' data-toggle='tooltip' data-placement='top' title='Editar'><i class='fa fa-edit size20'></i></a>  
                                              <a href='' data-toggle='modal' data-target='#usuario_{$user_id}' data-placement='top' title='Apagar' class='del'><i class='fa fa-remove size20'></i></a> ";                                        
