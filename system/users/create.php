            ...
            <div id="shieldui-grid1">
                ...
                if (isset($ClienteData["userCreate"])):
                    ...
                    if ($ClienteData['user_senha'] == $ClienteData['replica']):
                        ...
                        if ($res == 0):
                            //Verifica se o nivel não é Suporte
                            if ($ClienteData['user_nivel'] != 3):
                                ...
                                KLErro("<b>Erro</b>, O Nivel: Suporte, não pode ser cadastrado. Verifique!", KL_ALERT);
                            endif;
                ...
                <form role="form" class="form-horizontal txtblue" name="formUser" action="" method="post" id="frm">                          
                    ...
                    <div class="form-group">    
                        ...
                        <div class="col-xs-3">                                    
                            <input 
                                ...
                                placeholder="Ramal 4 digitos" 
                                value="<?php if (!empty($ClienteData['user_ramal'])) echo $ClienteData['user_ramal']; ?>" 
                                maxlength="4"
                                pattern = "[0-9]+$"
                                required                                 
                                >
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-lg-3">
                            <input type="password" class="form-control" name="user_senha" id="user_senha" placeholder="Senha Usuário" pattern = ".{6,12}" value="" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <input type="password" class="form-control" name="replica" id="replica" placeholder="Repita aSenha" value="" required>
