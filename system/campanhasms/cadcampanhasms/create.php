...
<div class="page-header">
    <h1>SMS Campanha <small>Cadastro!</small></h1>
</div>       
<!--</div>-->
            ...
            <div id="shieldui-grid1">
                ...
                <form role="form" class="form-horizontal txtblue" name="formCampanhaSms" action="" method="post" id="frm"> 
                    ...
                    <div class="form-group">
                        <label for="campanha_sms_tipo" class="col-sm-2 control-label">Campanha SMS Tipo</label>
                        <div class="col-xs-1">                                                       
                    ...
                    <div class="form-group">    
                        ...
                        <div class="col-xs-6">                                    
                            <input 
                                type="text" 
                                class="form-control" 
                                name="campanha_sms_nome" id="campanha_nome" 
                                placeholder="Nome da Campanha SMS" 
                                value="<?php if (!empty($Data['campanha_sms_nome'])) echo $Data['campanha_sms_nome']; ?>" 
                                required 
                                autofocus
                                >
                            <p class="help-block"><small>Informe o nome da campanha SMS.</small></p>
                        </div>                        
                    </div>
                    <!--DATA INICIO-->
                    <div class="form-group">    
                    ...
                    <div class="form-group">     
                        ...
                        <div class="col-xs-3"> 
                            <select class="form-control" name="campanha_sms_agenda" id="campanha_sms_agenda" required>
